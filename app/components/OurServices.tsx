    ...
    <div className='mt-[20px] md:mt-main bg-secbg px-4 md:px-main py-main'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-18 gap-5'>
        {services.map((el, i) => (
          <div
            key={i}
            className='flex flex-col bg-mainbg rounded-lg p-5 gap-10 hover:bg-gray-300 duration-500'
          >
            ...
            <a
              href='#'
              className='flex flex-row gap-2 items-center p-2 w-fit text-secbg font-semibold'
            >
              {el.link}
            </a>
          </div>
