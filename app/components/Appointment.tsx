...
function Appointment() {
  ...
  const showTimePic = () => {
    const dateInput = document.getElementById("picatime") as HTMLInputElement;
    if (dateInput) {
      dateInput.focus();
      dateInput.showPicker();
    }
...
//             <div className="flex flex-row w-[400px] justify-between bg-[#ab92fb] rounded-sm items-center text-white pr-3">
//               <select
//                 name="depatrment"
//                 className="w-full h-full bg-[#ab92fb] font-semibold focus:outline-0 appearance-none p-3"
...
//           </div>
//           <div className="flex flex-row gap-5">
//             <div className="flex flex-row w-[400px] p-3 text-white justify-between bg-[#ab92fb] rounded-sm items-center pr-3">
//               <input
//                 required
//                 type="text"
//                 className="w-full h-full font-semibold focus:outline-0 placeholder:text-white"
...
//           </div>
//           <div className="flex flex-row gap-5">
//             <div className="flex flex-row w-[260px] p-3 text-white justify-between bg-[#ab92fb] rounded-sm items-center pr-3">
//               <input
//                 required
//                 type="tel"
//                 className="w-full h-full font-semibold focus:outline-0 placeholder:text-white"
...
//             </div>
//             <div
//               className="flex flex-row w-[260px] p-3 text-white justify-between bg-[#ab92fb] rounded-sm items-center pr-3"
//               onClick={() => showDatePic()}
//             >
//               <input
//                 required
