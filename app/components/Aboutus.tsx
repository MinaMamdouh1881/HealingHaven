...
function Aboutus() {
  return (
    <div className="mt-[20px] md:mt-main px-4 md:px-10 lg:px-main flex flex-col md:flex-row gap-10 md:gap-20">
      <div className="flex flex-col md:max-w-[450px] gap-5">
        ...
        <p className="text-gray-400 leading-[20px] text-center md:text-left text-[15px] md:text-xl">
